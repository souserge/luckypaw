"""
Django settings for luckypaw project on Heroku. For more info, see:
...
WSGI_APPLICATION = 'luckypaw.wsgi.application'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    # Create the record that associates the user with the supervisor
    'app.aux.associate_user_with_sup',
)